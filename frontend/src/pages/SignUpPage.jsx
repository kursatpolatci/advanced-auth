...
function SignUpPage() {
  ...
  return (
    ...
    >
      <div className="p-8">
        <h2 className="text-center text-3xl font-bold mb-6 bg-gradient-to-r from-green-500 to-emerald-500 text-transparent bg-clip-text">
          Create Account
        </h2>
        ...
        <form onSubmit={handleSignup}>
          ...
          <motion.button
            className=" w-full mt-5 py-3 bg-gradient-to-r from-green-500 to-emerald-600 text-white
